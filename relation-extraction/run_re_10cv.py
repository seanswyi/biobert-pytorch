...
def main():
    ...
    if dataset_name in ['GAD', 'EUADR']:
        ...
        for split in data_splits:
            ...
            logger.info(f"F1: {final_results['f1']} | Acc: {final_results['acc']} | Time Elapsed: {final_results['training_time']}")
    ...
    if dataset_name in ['GAD', 'EUADR']:
        ...
        logger.info(f"Average F1 Scores: {average_f1_scores} | Average Accuracy: {average_acc}")
